...
function getSourcePaths() {
    var sourcePaths = jsdoc.util.runtime.sourceFiles.slice(0) || [];

    if (jsdoc.util.runtime.opts._) {
        jsdoc.util.runtime.opts._.forEach(function(sourcePath) {
            var resolved = path.resolve(jsdoc.util.runtime.pwd, sourcePath);
...
exports.defineTags = function(dictionary, tagDefinitions) {
    ...
    if (!tagDefinitions) {
        dictionaries = jsdoc.util.runtime.conf.tags.dictionaries;
