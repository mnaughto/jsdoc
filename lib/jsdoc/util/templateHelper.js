...
function useMonospace(tag, text) {
    ...
    if ( hasUrlPrefix(text) ) {
        ...
        cleverLinks = runtime.conf.templates.cleverLinks;
        monospaceLinks = runtime.conf.templates.monospaceLinks;
...
exports.prune = function(data) {
    ...
    if (!runtime.opts.access || (runtime.opts.access && runtime.opts.access.indexOf('all') === -1)) {
        if (runtime.opts.access && runtime.opts.access.indexOf('public') === -1) {
            data({access: 'public'}).remove();
        }
        if (runtime.opts.access && runtime.opts.access.indexOf('protected') === -1) {
            data({access: 'protected'}).remove();
        }
        if (!runtime.opts.private && (!runtime.opts.access || (runtime.opts.access && runtime.opts.access.indexOf('private') === -1))) {
            data({access: 'private'}).remove();
        }
        if (runtime.opts.access && runtime.opts.access.indexOf('undefined') === -1) {
